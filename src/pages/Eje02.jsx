const Eje02 = () => {
  return (
    <div>
      ...
      <div>
        <img className="border-8 border-red-400" src="https://picsum.photos/200/200" alt="random" />
        <img className="border-8 p-6 mt-5" src="https://picsum.photos/200/200" alt="random" />
      </div>
    </div>
  )
}
